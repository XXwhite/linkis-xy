...
public class MybatisConfiguration {
  ...
  public static final CommonVars<String> BDP_SERVER_MYBATIS_DATASOURCE_DRIVER_CLASS_NAME_HUA_WEI =
      CommonVars.apply(
          "wds.linkis.server.mybatis.huawei.datasource.driver-class-name", "org.postgresql.Driver");
