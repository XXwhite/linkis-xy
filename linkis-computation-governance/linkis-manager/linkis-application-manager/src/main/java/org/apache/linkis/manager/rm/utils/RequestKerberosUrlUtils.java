...
public class RequestKerberosUrlUtils {
  ...
  // XiongYi
  private static HttpClient buildSpengoHttpsClient()
    ...
    HttpClientBuilder builder = HttpClients.custom().setSSLSocketFactory(ssf);
          ...
          new PrivilegedAction<HttpResponse>() {
            ...
            public HttpResponse run() {
              try {
                ...
                // XiongYi
                HttpClient spnegoHttpClient = null;
                if (url.startsWith("https")) {
                  spnegoHttpClient = buildSpengoHttpsClient();
                } else {
